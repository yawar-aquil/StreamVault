...
export default function LoginPage() {
    ...
    return (
        <div className="relative flex min-h-screen w-full flex-row">
            <SEO
                title="Login"
                description="Log in to your StreamVault account to manage your watchlist, continue watching, and join community features."
                canonical="https://streamvault.live/login"
