...
function fixStrangerThingsLinks() {
  console.log('🔧 Fixing Stranger Things episode links (extracting file IDs)...\n');
  ...
  console.log(`✅ Fixed ${updatedCount} episode links!`);
  console.log('\n📊 All episodes now have file IDs only (not full URLs)');
}

fixStrangerThingsLinks();
